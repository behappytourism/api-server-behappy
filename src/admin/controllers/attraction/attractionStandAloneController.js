const { AttractionStandAlone, Attraction } = require("../../../models");
const { sendErrorResponse } = require("../../../helpers");
const { isValidObjectId } = require("mongoose");
const {
    attractionsStandAloneSchema,
    attractionsStandAloneUpdateSchema,
} = require("../../validations/attrStandAlone.Schema");

module.exports = {
    createNewAttractionStandAlone: async (req, res) => {
        try {
            const { title, description, shortDesc, attractions } = req.body;
    ...
    getAllAttractionStandAloneDetails: async (req, res) => {
        try {
            ...
            const totalStandAlone = await AttractionStandAlone.find({
                isDeleted: false,
                isActive: true,
            }).count();
    ...
    admUpdateStandAloneUpdate: async (req, res) => {
        try {
            ...
            const { title, description, attractions, initialImg, shortDesc } = req.body;
