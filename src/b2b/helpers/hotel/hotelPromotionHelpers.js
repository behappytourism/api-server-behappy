                                                ...
                                                if (
                                                    ...
                                                    if (
                                                        ...
                                                        appliedPromotions2.push({
                                                            ...
                                                            discountType:
                                                                sortedDiscounts[ac]?.discountType,
                                                            occupancyType:
                                                                disRoomType?.roomOccupancies[
                                                                    occupancyObjIndex
                                                                ]?.shortName,
                                                        ...
                                                        if (
                                                            ...
                                                            appliedTempDiscount +=
                                                                ...
                                                                (basePlan?.totalAddOnPrice /
                                                                    sortedDiscounts[ac]?.dates
                                                                        ?.length); // need to change based on single date addOn adding
                                                        }
                                                        appliedTempDiscount +=
                                                            (disRoomType?.roomOccupancies[
                                                                occupancyObjIndex
...
module.exports = { applyPromotion, getPromotionsWithCancellationType };
