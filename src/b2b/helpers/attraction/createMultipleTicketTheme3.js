...
const createMultipleTicketPdfTheme3 = async (ticketData, name) => {
    let combinedHtmlDoc = "";
    let options = {
        format: "A4",
        type: "buffer",
    ...
    for (let i = 0; i < tickets.length; i++) {
        ...
        <div style="min-width: 100vw; min-height: 100vh; background-color: white; margin: 0px;
        padding: 0; ">
            <div
                class="sec-1"
            ...
            >
                <div
                    ...
                    "
                >
  <img style="width: 200px; height: 100px; padding-left: 30px" src="${process.env.SERVER_URL}${
            ...
            >
              ...
              <div>
                ...
                <div>
                    ...
                    <div style="font-size: 14px">${ticket?.ticketFor}</div>
                    <div style="font-size: 14px; font-weight: bold">
                        --------------
                    </div>
                </div>
                <div>
                    <div style="font-size: 14px; font-weight: bold">Ticket No</div>
                    <div style="font-size: 14px">${ticket?.ticketNo}</div>
                    <div style="font-size: 14px; font-weight: bold">
                        --------------
                    </div>
                </div>
                <div>
                    <div style="font-size: 14px; font-weight: bold">Destination</div>
                    <div style="font-size: 14px">${ticketData?.destination?.name}</div>
                    <div style="font-size: 14px; font-weight: bold">
                        --------------
                    </div>
                </div>
                <div>
                    <div style="font-size: 14px; font-weight: bold">Valid Till</div>
                ...
                <div>
                <div style="font-size: 14px; font-weight: bold">Lot Number</div>
                <div style="font-size: 14px">${ticket?.lotNo}</div>
                <div style="font-size: 14px; font-weight: bold">
                    --------------
                </div>
            </div>
                <div>
                    ...
                    <div style="font-size: 14px">${
                        ticketData?.transferType === "without"
                            ? "Ticket Only"
